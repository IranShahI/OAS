                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nationalCode" placeholder="شماره ملی..."
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="address" placeholder="آدرس..."
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                <div style="margin: 2em">
                                    <button billing type="button" class="btn btn-success btn-lg btn-block noState">مبلغ قابل پرداخت برای ثبت نام :
                                    </button>
                                    <hr>
